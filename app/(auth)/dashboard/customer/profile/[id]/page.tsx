...
export default function CustomerUserProfilePage() {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <div className="flex items-center gap-5">
          <div className="w-20 h-20 rounded-full bg-gray-100 overflow-hidden flex items-center justify-center text-2xl font-bold text-blue-600">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{profile.role || "Host"}</p>
          ...
          <>
            <div className="flex items-center gap-2 mb-4">
              {[1, 2, 3, 4, 5].map((value) => (
                ...
                >
                  <svg
                    className={`w-7 h-7 ${reviewRating >= value ? "text-yellow-500" : "text-gray-300"}`}
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
